...
<div class="redirect-content" style="overflow:hidden" >
    ...
    <h3 class="title"><?php _e("Selamat ikan berhasil di upload",ET_DOMAIN);?></h3>
    <?php
    if($ad):
    ...
    ?>
        ...
        <?php
            ...
            <br/>
            <?php _e("Ikan kamu sedang di upload  ... ",ET_DOMAIN);?>
            <br/>
            <?php printf(__('Hitungan mundur: %s', ET_DOMAIN ), '<span class="count_down">10</span>');  ?>
        </div>
