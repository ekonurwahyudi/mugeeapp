...
<section class="section-wrapper section-register">
    <form class="form-mobile-wrapper signup_form">
        <input type="hidden" value="<?php _e("Penjual", ET_DOMAIN); ?>" class="work-text" name="worktext" />
        <input type="hidden" value="<?php _e("Pembeli", ET_DOMAIN); ?>" class="hire-text" name="hiretext" />

    	<div class="container">
            <div class="row">
                <div class="col-xs-7">
                    <span class="text-choose">
                        <?php _e("Pilih kategori:", ET_DOMAIN)?>
                    </span>
                </div>
                <div class="col-xs-5">
        ...
        <?php                       
            ...
            if(!$disable_name){
                ...
                <div class="form-group-mobile">
                    ...
                    <input type="text" id="first_name" name="first_name" placeholder="<?php _e("Nama Depan", ET_DOMAIN); ?>">
                </div>
                <div class="form-group-mobile">
                    <span class="icon-form-login icon-last-name"></span>
                    <input type="text" id="last_name" name="last_name" placeholder="<?php _e("Nama Belakang", ET_DOMAIN); ?>">
                </div>               
                <?php
            }               
        ?>
        ...
        <div class="form-group-mobile">
        	...
        	<input type="email" id="user_email" name="user_email" placeholder="<?php _e("Email Anda", ET_DOMAIN); ?>">
        </div>
        <div class="form-group-mobile">
        	<span class="icon-form-login icon-key"></span>
        	<input type="password" id="user_pass" name="user_pass" placeholder="<?php _e("Password Anda", ET_DOMAIN); ?>">
        </div>
        <div class="form-group-mobile">
        	<span class="icon-form-login icon-key"></span>
        	<input type="password" id="repeat_pass" name="repeat_pass" placeholder="<?php _e("Ulangi Password", ET_DOMAIN); ?>">
        </div>
        ...
        <div class="form-group policy-agreement">
            ...
            <?php printf(__(' ', ET_DOMAIN), et_get_page_link('tos') ); ?>
        </div>
        <?php } ?>
        <div class="clearfix"></div>
        <div class="form-group-mobile form-submit-btn">
            <button class="btn-sumary btn-submit"><?php _e("DAFTAR", ET_DOMAIN); ?></button>
        </div>
    </form>
    <div class="container">
    	<div class="row">
            ...
            ?>
                <a href="#" class="change-link-login">
                    <?php _e("Sudah punya akun ? Klik disini !", ET_DOMAIN); ?>
                </a>
          <?php
...
<section class="section-wrapper section-login">
    <form class="form-mobile-wrapper signin_form">
        ...
        <div class="form-group-mobile form-submit-btn">
            <a href="#" class="forgot-link change-link-forgot"><?php _e("Lupa Password?", ET_DOMAIN); ?></a>
            <div class="clearfix"></div>
        	<button class="btn-sumary btn-submit"><?php _e("MASUK", ET_DOMAIN); ?></button>
        </div>
    </form>
    <div class="container">
    	<div class="row">
        	<div class="col-md-12 change-form">
                ...
                <a href="#" class="change-link-register"><?php _e("Belum punya akun? Daftar sekarang", ET_DOMAIN); ?></a>
                <?php
                ...
                ?>
                    <div class="socials-head"><?php _e("Pilih kategori:", ET_DOMAIN) ?></div>
...
<section class="section-wrapper section-forgot collapse">
    <form class="form-mobile-wrapper forgot_form" id="forgot_form">
    	...
    	<div class="form-group-mobile">
        	<span class="icon-form-login icon-email"></span>
            <input type="text" id="user_email" name="user_email" placeholder="<?php _e("Masukan Email Anda", ET_DOMAIN) ?>">
        </div>
        <div class="form-group-mobile">
        	<a href="#" class="forgot-link change-link-login"><?php _e("Masuk ke akun", ET_DOMAIN); ?></a>
        </div>
        <div class="form-group-mobile form-submit-btn">
