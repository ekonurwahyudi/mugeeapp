...
class Fre_Notification extends AE_PostAction
{
    ...
    function bidAccepted($bid_id) {
        ...
        $notification = array(
            ...
            'post_title' => sprintf(__("Kamu adalah pemenang di %s", ET_DOMAIN) , get_the_title($project->ID))
        );
        return $this->insert($notification);
    }
    ...
    function completeProject($project_id, $args) {
        ...
        $notification = array(
            ...
            'post_status' => 'publish',
            'post_title' => sprintf(__("Lelang %s telah selesai", ET_DOMAIN) , get_the_title($project->ID))
        );
        return $this->insert($notification);
    }
    ...
    function fre_notify_item($notify) {
        ...
        switch ($type) {
            ...
            case 'new_bid':
                ...
                $content.= sprintf(__("%s Telah melakukan bid %s", ET_DOMAIN) , $author, $project_link);
                break;
                   // notify employer when his project have new bid
            // case 'new_project':
            ...
            case 'bid_accept':
                ...
                $content.= sprintf(__("Kamu adalah pemenang di lelang  %s  %s", ET_DOMAIN) , $project_link, $author);
                break;
            ...
            case 'complete_project':
                ...
                $content.= sprintf(__("%s Lelang kamu telah selasai %s", ET_DOMAIN) , $project_link, $author);
                break;
            ...
            case 'review_project':
                ...
                $content.= sprintf(__("%s Telah Melihat di %s", ET_DOMAIN) , $author, $project_link);
                break;
            ...
            case 'new_comment':
                ...
                $content.= sprintf(__("%s Telah berkomentar di %s", ET_DOMAIN) , $author, $project_link);
                break;
            ...
            $content.= sprintf(__(" Jam %s", ET_DOMAIN) , get_the_time('', $notify->ID));
            $content.= '&nbsp;';
            $content.= sprintf(__("| %s", ET_DOMAIN) , get_the_date('', $notify));
            $content.= '</span>';
